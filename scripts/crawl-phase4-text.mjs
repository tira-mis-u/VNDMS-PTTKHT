...
fs.mkdirSync("docs/05-architecture/phase-4-evidence", { recursive: true });
fs.writeFileSync("docs/05-architecture/phase-4-evidence/rendered-text-corpus.json", JSON.stringify(out, null, 2));
await browser.close();
