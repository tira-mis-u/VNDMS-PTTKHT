...
const output = path.resolve("docs/05-architecture/ui-system-full-repair-evidence/detail-and-interaction");
...
const detailRoutes = [
  ...
  ["thuc-thi-phuong-an", "/playbooks/PB-FLOOD-001/execute"],
  ["danh-gia-thiet-hai", "/recovery/assessments/DA-0241"],
  ["du-an-phuc-hoi", "/recovery/projects/RP-0241"],
  ["phan-tich-nguon-luc", "/analytics/resources"],
  ["phan-tich-su-co", "/analytics/incidents"],
];
