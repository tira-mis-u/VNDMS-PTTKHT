...
export const TICK_DEFINITIONS: TickDefinition[] = [
  ...
  },
  {
    ...
    event: {
      ...
      consequence: "INC-0241 được nâng mức Khẩn cấp và ghi timeline.",
  ...
  },
  {
    ...
    event: {
      ...
      consequence: "INC-0241 chuyển Đang xử lý; Playbook lũ ghi nhận trigger.",
  ...
  },
  {
    ...
    event: {
      ...
      consequence: "Tạo TSK-SIM-001 qua Task contract.",
  ...
  },
  {
    ...
    event: {
      ...
      consequence: "TSK-SIM-001 giao CH-05; Team chuyển Đang điều động.",
  ...
  },
  {
    ...
    event: {
      ...
      consequence: "Task hoàn thành, SOS đã xử lý, INC-0241 được kiểm soát.",
      mutation: "stabilize",
      entityType: "Incident",
      entityId: "INC-0241",
      entityPath: "/incidents/INC-0241",
  ...
  },
  {
    ...
    event: {
      ...
      reason: "Ứng phó khẩn cấp ổn định và đã có assessment xác minh.",
      consequence: "Tạo và khởi động RP-SIM-001 từ DA-0243.",
      mutation: "recovery-transition",
      entityType: "Recovery Project",
      entityId: "RP-SIM-001",
